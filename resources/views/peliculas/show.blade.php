<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Al aplicar livewire, la gate no gestiona bien la opcion de valorar, ya que como la pagina no se recarga, no se vuelve a comprobar si el usuario tiene una valoracion.-->
